...
namespace SignalIRWebUI.Controllers
{
    public class BookingController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7254/api/Booking/BookingStatusApproved/{id}");
            return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7254/api/Booking/BookingStatusCancelled/{id}");
            return RedirectToAction("Index");
        }
